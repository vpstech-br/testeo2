...
```
npm create cloudflare@latest -- --template=cloudflare/templates/testeo2
```

A live public deployment of this template is available at [https://testeo2.templates.workers.dev](https://testeo2.templates.workers.dev)
